...
public class Function
{
	...
	public static String encode(String s)
	{
	    ...
	    for (int i = 0; i < len; i++)
	    {
	    	...
	    	if ('A' <= ch && ch <= 'Z') {sbuf.append((char)ch);}		// 'A'..'Z'
	    	else if ('a' <= ch && ch <= 'z') {sbuf.append((char)ch);}	// 'a'..'z'
	    	else if ('0' <= ch && ch <= '9') {sbuf.append((char)ch);}	// '0'..'9'
	    	else if (ch == ' ') {sbuf.append("%20");}						// space
	    	...
	    	else if (ch <= 0x007f) {sbuf.append(hex[ch]);}				// other ASCII
